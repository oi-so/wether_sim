...
9 km・3 km・1 kmの全領域で動画と地図付き3D/2D HTMLを出力します。既存結果の更新は `./scripts/animate_weather_case.sh CASE --force`（WRF再計算なし）。自由な回転・中心移動、滑らかなメッシュ、地表13項目、白い雲・レーダー風の雨色に対応しました。[操作と出力先](docs/animation_3d.md) を参照してください。
